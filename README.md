...
## HTML Introduction 
<!DOCTYPE html>: Declares the document as an HTML5 file, helping browsers understand how to render the content.

<html lang="en">: Starts the HTML document. The lang="en" attribute specifies the content language as English.

<head> Section: Contains metadata about the webpage.

<meta charset="UTF-8"> ensures the webpage correctly displays characters.
...
</body> and </html>: These close the body and HTML document, respectively.
